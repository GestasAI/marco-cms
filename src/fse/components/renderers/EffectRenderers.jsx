 ...
 * Diseño Atómico y Modular: Soporta múltiples formas y modos de interacción.
 */
export const EffectRenderer = ({ element }) => {
    ...
    useEffect(() => {
        ...
        // 3. Crear Partículas según la forma seleccionada
        ...
        if (shape === 'points' || shape === 'lines' || shape === 'bubbles') {
            ...
            if (shape === 'lines') {
                ...
                // Bubbles use a different material or size
            ...
            // Instanced Mesh para rendimiento con formas 3D
